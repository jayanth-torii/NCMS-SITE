...
export const ADMIN_PAGES = [
  ...
  { key: "departmentsPage", label: "Departments Page", path: "/departments-page" },
  ...
  { key: "valueAddedCourse", label: "Value Added Course", path: "/value-added-course" },
  { key: "antiRagging", label: "Anti Ragging", path: "/anti-ragging" },
  { key: "antiSexualHarassment", label: "Anti Sexual Harassment", path: "/anti-sexual-harassment" },
  { key: "grievanceRedressal", label: "Grievance Redressal", path: "/grievance-redressal" },
  { key: "humanRights", label: "Human Rights", path: "/human-rights" },
  { key: "scAndSt", label: "SC & ST", path: "/sc-and-st" },
  ...
  { key: "sakhiSamrudhi", label: "Sakhi Samrudhi", path: "/sakhi-samrudhi" },
  { key: "unityCouncil", label: "Unity Council", path: "/unity-council" },

...
export default function Sports() {
  ...
  const sportsData = (event as any)?.sportsData as SportsData | null;
  ...
  if (!sportsData) {
    return <div className="text-center py-10 text-red-500">No Sports Data Found</div>;
  }
  ...
  return (
    <div className="mb-20">
      ...
      <div className="mt-8 space-y-4">
        {sportsData.accordionItem.map((item, index) => {
                        ...
                        <div className="block sm:hidden w-full">
                          <div className="flex flex-col justify-center items-center">
                            <Image
                              ...
                              alt={`Sports Image ${currentImageIndex + 1}`}
                              width={300}
                              height={200}

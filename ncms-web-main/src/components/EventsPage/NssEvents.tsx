...
export default function NssEvents() {
  ...
  const nssData = (event as any)?.NSSData as NSSData | null;
  ...
  if (!nssData) {
    return <div className="text-center py-10 text-red-500">No NSS Data Found</div>;
  }
  ...
  return (
    <div className="mb-20">
      ...
      <div className="mt-8 space-y-4">
        {nssData.accordionItem.map((item, index) => {
                        ...
                        <div className="block sm:hidden w-full">
                          <div className="flex flex-col justify-center items-center">
                            <Image
                              ...
                              alt={`NSS Image ${currentImageIndex + 1}`}
                              width={300}
                              height={200}
                          ...
                          {item.images
                            ...
                            .map((img, imgIndex) => (
                              ...
                              >
                                <Image
                                  src={img}
                                  alt={`NSS Image ${imgIndex + 1}`}
                                  width={300}
                                  height={200}
                                  className="w-full h-64 aspect-[4/3] object-cover rounded-md shadow-md"
                                />
                              </div>
                            ))}
                        </div>

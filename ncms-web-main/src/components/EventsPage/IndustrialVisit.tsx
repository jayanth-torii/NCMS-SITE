...
export default function IndustrialVisits() {
  ...
  const industrialVisitData = (event as any)?.industrialVisitData as IndustrialVisitData | null;
  ...
  if (!industrialVisitData) {
    return <div className="text-center py-10 text-red-500">No Industrial Visit Data Found</div>;
  }

  return (
    <div className="mb-20">
      <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-[#003333]">
        {industrialVisitData.title}
      </h2>

      <div className="mt-8 space-y-4">
        {industrialVisitData.accordionItem.map((item, index) => {
                        ...
                        <div className="block sm:hidden w-full">
                          <div className="flex flex-col justify-center items-center">
                            <Image
                              ...
                              alt={`Industrial Visit ${currentImageIndex + 1}`}
                              width={300}
                              height={200}

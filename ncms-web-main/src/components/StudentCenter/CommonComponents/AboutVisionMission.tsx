...
interface AboutVisionMissionData {
  AboutSection?: AboutSection;
  VisionMission?: VisionMissionSection;
  AccordionSections?: AccordionItem[];
}

export default function AboutVisionMission({ data }: { data: AboutVisionMissionData | null }) {
  if (!data) return null;
  ...
  return (
    <div className="bg-white mb-20">
      ...
      {visionMission?.VMSections && visionMission.VMSections.length > 0 && (
        <div className="mb-3">
          <div

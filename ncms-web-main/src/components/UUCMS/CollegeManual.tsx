...
export default function CollegeManual({data}:any) {
    ...
    return (
        <div>
            <div className="items-center gap-10 mb-20 flex flex-col md:flex-row">
                {/* Text Section */}
                <div className="space-y-4 bg-[#F6F6F6] p-8 h-74 md:h-80 w-full md:w-[45%]">
                    ...
                    <p className="text-justify md:w-[80%] text-gray-700 mb-5">{newsletterData?.description}</p>
                    <button className="px-6 py-3 bg-[white] cursor-pointer border border-[#0E2455] text-[#0E2455] font-semibold" onClick={()=>openPdf(newsletterData?.pdf)}>

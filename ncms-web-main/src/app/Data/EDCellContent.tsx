const EDCellContent = {
    ...
    aboutSections: [{
        title: "ABOUT ED CELL",
        description: `Economic development of a country is supported by entrepreneurship in several ways. It is a key contributor to innovativeness, product improvement and a pivotal ingredient to employment creation.  
    ...
    visionMission: {
        vision: {
            title: "VISION",
            description: "To instill and cultivate an entrepreneurial culture and rational decision-making mindset among students.",
        },
        mission: {
            title: "MISSION",
            points: [
                ...
                "To promote social entrepreneurship, that focuses on creating businesses with social and environmental impact, addressing societal challenges, and fostering sustainable development of students in the future.",
            ],
        },
    },
    ...
    collapsibleSections: {
        objectives: {
            title: "Objectives",
            points: [
                "To create awareness on opportunities and benefits of entrepreneurship among students.",
    ...
    policies: {
        ...
        policyPdf: "/pdfs/student-center/ed/ED-Cell.pdf",
        compositionPdf : "/pdfs/student-center/ed/E-D-Cell.pdf",
